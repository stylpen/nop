// $ANTLR 3.4 C.g 2012-05-05 11:16:32
...
public class CLexer extends Lexer {
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:489:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' )
            // C.g:489:8: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 

            // C.g:489:12: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
            loop3:
            do {
                int alt3=3;
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // C.g:523:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | OctalEscape )
            int alt28=2;
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // C.g:529:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt29=3;
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // C.g:536:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // C.g:536:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:542:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // C.g:542:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 



            // C.g:542:14: ( options {greedy=false; } : . )*
            loop30:
            do {
                int alt30=2;
